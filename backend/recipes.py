...
IMG = {
    ...
    "gratin": "https://images.unsplash.com/photo-1574484284002-952d92456975?w=900&q=80",
...
MAIN_BLUEPRINTS: List[Dict[str, Any]] = [
    ...
    B("bowl_tacos", "Bowl tacos au bœuf", "taco_bowl", "bowl", ["boeuf_steak_hache5", "poulet"], ["tomate", "salade_verte", "poivron", "oignon"], ["riz", "riz_complet", "haricots_rouges", "haricots_blancs"], extras=["cumin", "paprika", "citron vert", "coriandre"], minutes=18),
    ...
    B("riz_cantonais", "Riz cantonais léger", "fried_rice", "wok", ["gambas", "crevettes", "oeuf", "jambon_blanc"], ["petits_pois", "carotte", "poivron", "champignons"], ["riz", "riz_complet"], extras=["ciboulette", "sauce soja réduite en sel"], minutes=18, quick=True),
    ...
    B("adapt_parmentier", "Parmentier léger de {protein} & {veg}", "parmentier", "gratin", ["boeuf_steak_hache5", "dinde", "cabillaud", "colin", "saumon", "lentilles"], ["carotte", "epinard", "poireau", "champignons", "courgette", "brocoli", "potimarron"], ["pomme_de_terre", "patate_douce"], extras=["muscade", "persil"], minutes=30, adaptive=True, moods=["comfort"]),
    ...
    B("adapt_risotto", "Risotto crémeux {veg} & {protein}", "risotto", "risotto", ["poulet", "dinde", "crevettes", "gambas", "saint_jacques", "saumon", "cabillaud", "tofu"], ["courgette", "champignons", "asperge", "poireau", "epinard", "potimarron", "petits_pois"], ["riz", "riz_complet"], extras=["persil", "poivre"], minutes=25, adaptive=True, moods=["comfort"]),
    ...
    B("adapt_brochettes", "Brochettes de {protein}, {veg} & {starch}", "skewers", "meat", ["poulet", "dinde", "boeuf", "boeuf_bavette", "saumon", "gambas", "crevettes", "tofu"], ["courgette", "poivron", "champignons", "aubergine", "tomate", "oignon"], ["riz", "riz_complet", "quinoa", "boulgour", "semoule", "pomme_de_terre", "patate_douce"], extras=["citron", "paprika", "herbes de Provence"], minutes=20, adaptive=True),
...
BREAKFAST_BLUEPRINTS: List[Dict[str, Any]] = [
    ...
    B("tartines_salees", "Tartines salées", "savory_toast", "savory_breakfast", starches=["pain_complet", "biscottes", "muffin_anglais"], requires=("starch", "protein"), minutes=10, quick=True),
...
def _de(name: str) -> str:
    n = name.lower()
    return ("d'" + n) if n[:1] in "aeiouyhéèêœ" else ("de " + n)
