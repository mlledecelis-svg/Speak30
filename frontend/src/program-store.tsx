...
export type Recipe = { lifestyle?: string[]; blueprint_id: string; name: string; method: string; image: string; steps: string[]; minutes: number; difficulty: string; difficulty_label: string; extras: string[]; quick: boolean; moods: string[]; mode?: string | null };
